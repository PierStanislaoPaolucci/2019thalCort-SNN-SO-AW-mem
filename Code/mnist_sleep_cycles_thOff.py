...
for n_cycle in range(N_cycles):
    ...
    sio.savemat('accuracy_vector_' +str(subset)+ '_thOff.mat', {'accuracy_vector':accuracy_vector})
    sio.savemat('w_' +str(subset)+ '_thOff' +str(n_cycle)+  '.mat', {'w':w_pre_sleep})
    sio.savemat('n_spikes_' +str(subset)+ '_thOff' +str(n_cycle)+  '.mat', {'n_spikes':fr_vector})
